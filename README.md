...
- 📱 Created the [Grade Calculator](https://play.google.com/store/apps/details?id=com.gsaprod.gradecalculator) mobile app, available for Android devices

- 💡 Interested in mobile and full-stack development, as well as cloud infrastructure management

- 🌱 Eager to explore new tools for development and deployment, in order to contribute to impactful projects
